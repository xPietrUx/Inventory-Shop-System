...
urlpatterns = [
    ...
    path("software/<int:pk>/edit/", views.software_edit_view, name="software_edit"),
    path(
        "software/<int:pk>/delete/", views.software_delete_view, name="software_delete"
    ),
    ...
    path("license/<int:pk>/edit/", views.license_edit_view, name="license_edit"),
    path("license/<int:pk>/delete/", views.license_delete_view, name="license_delete"),
]
